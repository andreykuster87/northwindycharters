// src/components/CreateTripModal/shared/Stepper.tsx
import { CheckCircle2 } from 'lucide-react';
import { TABS, type TabN } from '../../constants/constants';

export function Stepper({ current, done }: { current: TabN; done: Set<number> }) {
  return (
