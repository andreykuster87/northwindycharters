...
export function ReservasBox({
  ...
  return (
    <div className="bg-white rounded-[25px] border-2 border-gray-100 overflow-hidden w-full">
      <button onClick={handleOpen} className="w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 transition-all">
        <div className="flex items-center gap-3">
          ...
          <span className="font-black text-blue-900 text-sm uppercase tracking-wide">Minhas Reservas</span>
          {bookings.length > 0 && (
        ...
        <div className="px-4 pb-4 space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          {bookings.length === 0 ? (
            <div className="py-6 text-center">
              ...
              <p className="font-black text-gray-300 uppercase italic text-xs">Nenhuma reserva ainda</p>
            </div>
          ) : (
